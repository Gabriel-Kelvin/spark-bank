...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background-color: #49243E; font-family: candara; font-size: 18px; box-shadow: 0px 0px 10px 0px black;">
    <div class="container-fluid">
        <a href="index.php"><img src="assets/lo4.png" alt="" style="height: 80px; margin-left: 25px; margin-top: 10px;"></a>
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <img src="assets/naantha.jpeg" alt="" style="width:15%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:white;">This website is created by</p>
            <h1 style="color:white; text-shadow:2px 2px 2px gray;"> Gabriel Kelvin F </h1>
            <p style="color:gray;"><b>Intern at Sparks Foundation <br>Student of<br> Christ University, Bangalore, India </b></p>
    </center>
